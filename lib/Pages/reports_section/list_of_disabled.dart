...
class ListOfDisabled extends StatefulWidget {
  const ListOfDisabled({super.key});

  @override
  State<ListOfDisabled> createState() => _ListOfDisabledState();
}

class _ListOfDisabledState extends State<ListOfDisabled> {
  ...
  Future<void> _loadData() async {
    try {
      final data = await DatabaseHelper2.instance.getDisabled();
      ...
      debugPrint("Error loading Disabled data: $e");
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("List of Disabled Pensioners"),
                          ...
                          : SingleChildScrollView(
                              ...
                              child: SingleChildScrollView(
                                child: DataTable(
                                  ...
                                  rows: _paginatedRows.asMap().entries.map((
                                    entry,
                                  ) {
                                    final index = entry.key;
                                    final row = entry.value;
                                    final id =
                                        _valueFor(row, 'id')?.toString() ?? '';
