...
class ListOfPensionersScreen extends StatefulWidget {
  ...
  const ListOfPensionersScreen({super.key, this.onEditPensioner});

  @override
  State<ListOfPensionersScreen> createState() => _ListOfPensionersScreenState();
}

class _ListOfPensionersScreenState extends State<ListOfPensionersScreen> {
  ...
  final List<Map<String, String>> _fields = [
    ...
    {'label': 'Civil Education', 'key': 'civil_edn'},
    {'label': 'Military Qual', 'key': 'mil_qual'},
    {'label': 'Medical Cat', 'key': 'med_cat'},
    {'label': 'Character', 'key': 'character'},
    {'label': 'Cause Discharge', 'key': 'cause_disch'},
    {'label': 'Village', 'key': 'village'},
    {'label': 'Post Office', 'key': 'post_office'},
    {'label': 'UC Name', 'key': 'uc_name'},
    {'label': 'Tehsil', 'key': 'tehsil'},
    {'label': 'District', 'key': 'district'},
    {'label': 'Present Address', 'key': 'present_addr'},
    {'label': 'CNIC', 'key': 'cnic'},
    {'label': 'Cmp CNIC No', 'key': 'cmp_cnic_no'},
    {'label': 'ID Marks', 'key': 'id_marks'},
    {'label': 'Railway Station', 'key': 'railway_station'},
    ...
    {'label': 'NOK Date of Birth', 'key': 'nok_do_birth'},
    {'label': 'NOK ID Marks', 'key': 'nok_id_mks'},
    {'label': 'NOK GPO', 'key': 'nok_gpo'},
    {'label': 'NOK PDO', 'key': 'nok_pdo'},
    {'label': 'NOK PSB No', 'key': 'nok_psb_no'},
    {'label': 'NOK PPO No', 'key': 'nok_ppo_no'},
    {'label': 'NOK Bank Name', 'key': 'nok_bank_name'},
    {'label': 'NOK Bank Branch', 'key': 'nok_bank_branch'},
    {'label': 'NOK Bank Account No', 'key': 'nok_bank_acct_no'},
    {'label': 'NOK IBAN No', 'key': 'nok_iban_no'},
    {'label': 'Net Pension', 'key': 'net_pension'},
    {'label': 'NOK Net Pension', 'key': 'nok_net_pension'},
    {'label': 'GPO', 'key': 'gpo'},
    {'label': 'PDO', 'key': 'pdo'},
    {'label': 'PSB No', 'key': 'psb_no'},
    {'label': 'PPO No', 'key': 'ppo_no'},
    {'label': 'Bank Name', 'key': 'bank_name'},
    {'label': 'Bank Branch', 'key': 'bank_branch'},
    {'label': 'Bank Account No', 'key': 'bank_acct_no'},
    ...
    {'label': 'Tomb Stone', 'key': 'tomb_stone'},
    {'label': 'Citation Shaheed', 'key': 'citation_shaheed'},
    {'label': 'DO Disability', 'key': 'do_disability'},
    {'label': 'Nature Disability', 'key': 'nature_disability'},
    {'label': 'CL Disability', 'key': 'cl_disability'},
    {'label': 'Cause Disability', 'key': 'cause_disability'},
    {'label': 'Shaheed Remarks', 'key': 'shaheed_remarks'},
    {'label': 'Disable Remarks', 'key': 'disable_remarks'},
    {'label': 'General Remarks', 'key': 'gen_remarks'},
    {'label': 'DASB', 'key': 'dasb'},
    {'label': 'Register Page', 'key': 'register_page'},
    {'label': 'Date Verification', 'key': 'date_verification'},
    {'label': 'Source Verification', 'key': 'source_verification'},
    {'label': 'DCS Start Month', 'key': 'dcs_start_month'},
  ...
  Future<void> _loadData() async {
    try {
      ...
      print("Loaded keys: ${data.first.keys}");
    } catch (e) {
      debugPrint("Error loading pensioners data: $e");
    }
  }
  ...
  Future<void> _exportToExcel() async {
    try {
      ...
      final sheet = excel['Disabled Pensioners'];
      ...
      final filePath = "${directory.path}/disabled_pensioners.xlsx";
  ...
  Future<void> _exportToPdf() async {
    try {
      ...
      final directory = await getApplicationDocumentsDirectory();
      final filePath = "${directory.path}/disabled_pensioners.pdf";
      final file = File(filePath);
      ...
      //     bytes: await pdf.save(), filename: 'disabled_pensioners.pdf');
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("List of Pensioners"),
                    ...
                    columns: [
                      ...
                      ..._fields.asMap().entries.map((entry) {
                        ...
                        if (_selectedFilters.containsKey(key)) {
                          final options = _filterOptions[key] ?? <String>[];
                          return DataColumn(
                    ...
                    rows: _paginatedRows.asMap().entries.map((entry) {
                      ...
                      return DataRow(
                        ...
                        cells: [
                          ...
                          ..._fields.asMap().entries.map((fieldEntry) {
